...
namespace NRustLightning.Server
{
    ...
    {
        public static IServiceCollection AddNRustLightning(this IServiceCollection services)
        {
        ...
        public static IServiceCollection ConfigureNRustLightning(this IServiceCollection services, IConfiguration configuration, ILogger logger)
        {
