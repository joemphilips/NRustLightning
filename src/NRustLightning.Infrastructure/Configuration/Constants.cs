...
namespace NRustLightning.Infrastructure.Configuration
{
    public static class Constants
    {
        ...
        public static string DefaultCertFile = Path.Combine(HomePath, ".aspnet", "https", "ssl.cert");
        ...
        public static IPEndPoint DefaultP2PExternalIp = (IPEndPoint)NBitcoin.Utils.ParseEndpoint(DefaultP2PHost, DefaultP2PPort);
